...
export default function Home() {
  return (
    <>
      <Head>
        <title>Coming Soon | Digital Marketing & Custom Development</title>
        <meta name="description" content="Strategic digital marketing and custom development for businesses ready to scale. Coming soon." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
